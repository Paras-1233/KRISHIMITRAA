...
import {
  ShoppingCart, User, LogOut, Search, Filter,
        ...
        {sidebarOpen && (
          <div className="space-y-4 mt-4">
            ...
            <button
              ...
              className={`flex items-center gap-2 px-4 py-2 w-full text-left rounded-lg ${
                activeTab === 'products' ? 'bg-green-100 text-green-700' : 'hover:bg-gray-100'
              }`}
            >
            ...
            <button
              ...
              className="flex items-center gap-2 px-4 py-2 w-full text-left rounded-lg hover:bg-gray-100"
            >
              <ShoppingCart size={18} />
              Cart ({cart.length})
            </button>
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {filteredProducts.map((product, index) => (
                <div key={index} className="bg-white border border-gray-200 rounded-lg shadow hover:shadow-lg transition">
                  <img
                    src={product.image}
                    alt={product.name}
